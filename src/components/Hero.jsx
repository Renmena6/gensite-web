    ...
    <header id="inicio" className="relative py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="#contacto"
            className="bg-blue-600 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:bg-blue-700 shadow-xl shadow-blue-200 transition-all hover:-translate-y-1 inline-block text-center"
          >
            Empezar ahora
          </a>
          ...
          <a
            href="#ia-solutions"
            className="bg-white border-2 border-slate-200 text-slate-700 px-10 py-4 rounded-2xl font-bold text-lg hover:border-blue-600 hover:text-blue-600 transition-all inline-block text-center"
          >
            Ver demos
          </a>
        </div>
